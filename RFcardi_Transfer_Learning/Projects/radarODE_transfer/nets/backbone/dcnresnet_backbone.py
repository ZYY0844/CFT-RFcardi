...
from Projects.radarODE_transfer.nets.backbone.dcnv2 import DeformConv2d
...
class DCNResNet(nn.Module):
    def __init__(self, in_channels, out_channels=512):
        ...
        # self.stage_channels = [in_channels, 32, 64, 128, 256]
        self.stage_channels = [in_channels, 32, 128, 256, 512]
...
if __name__ == '__main__':
    model = DCNResNet(in_channels=10)
    input_map = torch.randn(2, 10, 71, 120)
    output_map = model(input_map)
    print(output_map.shape)
    print(summary(model, input_size=(2, 10, 71, 120), device='cpu'))