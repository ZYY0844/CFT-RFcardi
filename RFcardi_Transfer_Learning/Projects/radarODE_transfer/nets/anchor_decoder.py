...
class anchor_decoder(nn.Module):
    def __init__(self, dim = 256):
        ...
        self.conv = nn.Sequential(
            ConvBlock(dim // 8, dim // 8, kernel_size=5, stride=2, padding=2),
            ConvBlock(dim // 8, dim // 16, kernel_size=5, stride=1, padding=2),
            ConvBlock(dim // 16, 16, kernel_size=5, stride=1, padding=2),
